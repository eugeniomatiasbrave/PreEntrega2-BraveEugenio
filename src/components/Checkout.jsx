...
import { Container,Input,Button,Text,Center,FormControl,FormLabel} from "@chakra-ui/react";
...
const Checkout = () => {
    ...
    const handleSubmit =(e)=>{
      ...
      productos: cart.map((vln) => ({id:vln.id, precio_total:vln.cantidad * vln.price}
        ))
       }
    ...
    <Container>
            ...
            <Center w="600 px" bg="gray.100" borderWidth='2px'>
              <FormControl m={3}>
                ...
                <Button m={4} type='submit' onClick={handleSubmit} variant="solid" colorScheme="red" size='sm'>Enviar y confirmar Compra</Button>
              </FormControl>    
              </Center>
    </Container>
    <Center>
       <Text m={3} fontSize="xl">Compra Confirmada: </Text>
      </Center>     
         <Center>
